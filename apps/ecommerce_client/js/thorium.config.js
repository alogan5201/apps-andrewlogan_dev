...
const kLocalRoot = "http://localhost:8080/ecommerce_client3/";
...
const kSkipButtonText="Skip for now";
const kAddToHomeScreenTitle="Install";
const kAddToHomeScreenMdText="Click on the button #ICON at the bottom, and select \'Add to Home Screen\' option";
const kAddToHomeScreenIosText="Click on the button #ICON at the bottom, and select \'Add to Home Screen\' option";
...
const firebaseFbAuth=true;
const firebaseGoogleAuth=true;
...
{
    path: '/history/',
    url: './pages/history.html?r=63277',
    name: 'history',
},
{
    path: '/orderdetail/',
    url: './pages/orderdetail.html?r=43180',
    name: 'orderdetail',
},
{
    path: '/productdetail/',
    url: './pages/productdetail.html?r=10924',
    name: 'productdetail',
},
{
    path: '(.*)',
