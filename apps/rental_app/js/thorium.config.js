...
const kLocalRoot = "http://localhost:8080/rental_app/";
...
{
    path: '/contact/',
    url: './pages/contact.html?r=88581',
    name: 'contact',
},
{
    path: '/pictures/',
    url: './pages/pictures.html?r=88749',
    name: 'pictures',
},
{
    path: '/food/',
    url: './pages/food.html?r=76759',
    name: 'food',
},
{
    path: '(.*)',
