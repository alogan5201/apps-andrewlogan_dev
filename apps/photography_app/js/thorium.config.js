...
const kLocalRoot = "http://localhost:8080/photography_app/";
...
const kPhotoBrowserTheme="light";
...
{
    path: '/about/',
    url: './pages/about.html?r=24523',
    name: 'about',
},
{
    path: '/portfolio/',
    url: './pages/portfolio.html?r=93427',
    name: 'portfolio',
},
{
    path: '/blog/',
    url: './pages/blog.html?r=65224',
    name: 'blog',
},
{
    path: '(.*)',
