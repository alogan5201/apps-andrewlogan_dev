...
const kLocalRoot = "http://localhost:8080/instaclone/";
...
const kAddToHomeScreenMdText="Click on the button #ICON at the bottom, and then select the \'Add to Home Screen\' option";
...
{
    path: '/editpost/',
    url: './pages/editpost.html?r=16798',
    name: 'editpost',
},
{
    path: '/detailuser/',
    url: './pages/detailuser.html?r=29127',
    name: 'detailuser',
},
{
    path: '(.*)',
